...
namespace Illuminate\Support\Facades {
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            ...
            return \App\Core\Console\Kernel::handle($input, $output);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \App\Core\Console\Kernel::terminate($input, $status);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \App\Core\Console\Kernel::command($signature, $callback);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \App\Core\Console\Kernel::registerCommand($command);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \App\Core\Console\Kernel::call($command, $parameters, $outputBuffer);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \App\Core\Console\Kernel::queue($command, $parameters);
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \App\Core\Console\Kernel::all();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \App\Core\Console\Kernel::output();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \App\Core\Console\Kernel::bootstrap();
        }
        ...
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \App\Core\Console\Kernel::setArtisan($artisan);
        }
...
namespace BrianFaust\Alert\Facades {
    ...
    class Alert {
        ...
        {
            return \BrianFaust\Alert\Alert::success($message, $title);
        }
        ...
        {
            return \BrianFaust\Alert\Alert::info($message, $title);
        }
        ...
        {
            return \BrianFaust\Alert\Alert::warning($message, $title);
        }
        ...
        {
            return \BrianFaust\Alert\Alert::error($message, $title);
        }
        ...
        {
            return \BrianFaust\Alert\Alert::important();
        }
        ...
        {
            return \BrianFaust\Alert\Alert::overlay($message, $title);
        }
         ...
         * @static 
         */
        public static function flash($message, $level = 'info', $title = 'Notice', $overlay = false)
        {
            return \BrianFaust\Alert\Alert::flash($message, $level, $title, $overlay);
        }
...
namespace {
    ...
    class Alert extends \BrianFaust\Alert\Facades\Alert {}
