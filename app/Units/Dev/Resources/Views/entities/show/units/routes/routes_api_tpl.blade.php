<pre>
<code class="php" id="{{ $provider }}_routes_api_tpl">/*
|--------------------------------------------------------------------------
| {{ $entity['reflectionClass']->getShortName() }} Api {{ ucfirst($provider) }} Routes
|--------------------------------------------------------------------------
*/
$this->router->group([
...
</code>{{ Html::bsClipboard("{$provider}_routes_api_tpl") }}
</pre>