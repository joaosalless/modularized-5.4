            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="{{ !session('tab_active') || session('tab_active') == 'cadastro' ? 'active' : '' }}">
                    <a href="#cadastro" aria-controls="cadastro" role="tab" data-toggle="tab">
                        {{ $entity->getLabel('data') }}
                    </a>
                </li>
                <li role="presentation" class="{{ session('tab_active') && session('tab_active') == 'medias' ? 'active' : '' }}">
                    <a href="#medias" aria-controls="medias" role="tab" data-toggle="tab">
                        {{ $entity->getLabel('medias') }}
                    </a>
                </li>
                <li role="presentation" class="{{ session('tab_active') && session('tab_active') == 'access_log' ? 'active' : '' }}">
                    <a href="#access_log" aria-controls="access_log" role="tab" data-toggle="tab">
                        {{ $entity->getLabel('history') }}
                    </a>
                </li>
            </ul>
        </div>
