    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="padding-bottom: 0;">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="{{ session('tab_active') && session('tab_active') == 'medias' ? 'active' : '' }}"><a href="#medias" aria-controls="medias" role="tab" data-toggle="tab">Anexos</a></li>
